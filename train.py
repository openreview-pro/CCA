...
if __name__ == '__main__':
    ...
    parser.add_argument('--net', type = str, choices=['LeNet5', 'AlexNet', 'VGG16','VGG19','ResNet18','VGG16',
                                                       'DenseNet','MobileNetv1','MobileNetv2'], default='ResNet34', help='net type')
    parser.add_argument('--epochs', type = int, default=80, help = 'Epochs')
    parser.add_argument('--resume', '-r', action='store_true', help='resume from checkpoint')
    parser.add_argument('--patience', '-p', type = int, default=10000, help='patience for Early stop')
    parser.add_argument('--optim','-o',type = str, choices = ['sgd','adam','adamw'], default = 'sgd', help = 'choose optimizer')
    ...
    scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', factor=0.96,verbose=True,patience = 1,min_lr = 0.000001) # 动态更新学习率
